<?php
    ...
    define('child_theme_name', 'isi');
    define('greensock_url', '');
    define('google_fonts_url', '');

    //enqueue stylesheets
    function enqueue_isi_theme_styles() {
    ...
    add_action( 'wp_enqueue_scripts', 'enqueue_isi_theme_styles');

    //enqueue scripts
    function enqueue_isi_theme_scripts() {
    ...
    add_action( 'get_footer', 'enqueue_isi_theme_scripts');

    //Enqueue Google Fonts
    function enqueue_isi_theme_fonts() {
    ...
    add_action( 'get_footer', 'enqueue_isi_theme_fonts' );
